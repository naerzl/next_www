  ...
  return (
    <>
      <div className="custom-background phone:text-lg">
        ...
        <div className="text-3xl mb-20 phone:text-lg">
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;便捷、快速的记录工程从开始、施工到竣工的相关数据。
        </div>
        <div
          className="w-36 h-12 flex items-center justify-center rounded bg-sky-300 text-base text-white phone:text-lg"
        ...
        <div
          className="w-48 h-24 flex rounded-md bg-white  items-center justify-around phone:text-lg"
          style={boxStyle}
          onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave}>
